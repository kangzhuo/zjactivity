...
public class XmlCreateTest {
    ...
    private static String g_strName = "121.43.106.10";
    private static String g_strAcctSeq = "121.43.106.10";
    ...
    public static String sendHttpMsg(String p_strUrl, byte[] p_postData, String p_strReferer) throws Exception {
